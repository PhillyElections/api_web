...
class Autocomplete
{
    ...
    protected function setup()
    {
        ...
        $this->fields = 'TRIM(REPLACE(CONCAT_WS(\' \', \'' . $number .'\', prefix_dir, proper(TRIM(LEADING \'0\' FROM street_name)), proper(type_dir)), \'  \', \' \')) as label, SUBSTRING(precinct_split, 4) as division';
